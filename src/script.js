          ...
          fetched_levels.map(({ title, courses: raw_courses }) => {
            ...
            raw_courses.forEach((course) => {
              ...
              if (course.isElective) {
                ...
                let classroom_score =
                  ((_a = course.summaryEnrolled[0]) === null || _a === void 0
                    ? void 0
                    : _a.classroomAverage) || undefined;
                if (classroom_score) {
        ...
        level_courses.map(async (level_course) => {
          const xata_level = XataRecords.levels.find((xata_level) => {
            ...
            return (
              ...
              ((_a = xata_level.curriculum) === null || _a === void 0
                ? void 0
                : _a.handle) === level_course.level.curriculum.handle
            );
          });
          if (!xata_level) {
      ...
      XataRecords.evaluations = await Promise.all(
        evaluations.map(async (evaluation) => {
          const xata_class = XataRecords.classes.find((clase) => {
            var _a, _b;
            const xata_course_id =
              ((_a = clase.course) === null || _a === void 0
                ? void 0
                : _a.id) || "123";
            const xata_course = XataRecords.courses.find(
              (course) => course.id === xata_course_id
            );
            const xata_period_id =
              ((_b = clase.period) === null || _b === void 0
                ? void 0
                : _b.id) || "123";
            const xata_period = XataRecords.periods.find(
            ...
            return (
              (xata_course === null || xata_course === void 0
                ? void 0
                : xata_course.handle) === evaluation.clase.course.handle &&
              (xata_period === null || xata_period === void 0
                ? void 0
        ...
        classrooms.map(async (classroom) => {
          ...
          if (classrooms_matched.length > 0) {
            ...
            return await Xata.db.classroom.create({
              ...
              class: xata_class.id,
              teacher:
                xata_teacher === null || xata_teacher === void 0
                  ? void 0
                  : xata_teacher.id,
  ...
  XataRecords.enrollments = await Promise.all(
    enrollments.map(async (enrollment) => {
      ...
      const xata_classroom = XataRecords.classrooms.find((classroom) => {
        var _a, _b;
        const xata_class_id =
          ((_a = classroom.class) === null || _a === void 0 ? void 0 : _a.id) ||
          "123";
        ...
        const xata_course_id =
          ((_b =
            xata_class === null || xata_class === void 0
              ? void 0
              : xata_class.course) === null || _b === void 0
            ? void 0
            : _b.id) || "123";
        const xata_course = XataRecords.courses.find(
          (course) => course.id === xata_course_id
        ...
        return (
          (xata_course === null || xata_course === void 0
            ? void 0
            : xata_course.handle) === enrollment.classroom.clase.course.handle
        );
      });
      if (!xata_classroom) {
  ...
  XataRecords.scores = await Promise.all(
    scores.map(async (score) => {
      const xata_enrollment = XataRecords.enrollments.find((enrollment) => {
        var _a, _b, _c;
        const xata_classroom_id =
          ((_a = enrollment.classroom) === null || _a === void 0
            ? void 0
            : _a.id) || "123";
        ...
        const xata_class_id =
          ((_b =
            xata_classroom === null || xata_classroom === void 0
              ? void 0
              : xata_classroom.class) === null || _b === void 0
            ? void 0
            : _b.id) || "123";
        const xata_class = XataRecords.classes.find(
          (clase) => clase.id === xata_class_id
        ...
        const xata_course_id =
          ((_c =
            xata_class === null || xata_class === void 0
              ? void 0
              : xata_class.course) === null || _c === void 0
            ? void 0
            : _c.id) || "123";
        const xata_course = XataRecords.courses.find(
          (course) => course.id === xata_course_id
      ...
      const xata_evaluation = XataRecords.evaluations.find((evaluation) => {
        var _a, _b, _c;
        const xata_class_id =
          ((_a = evaluation.class) === null || _a === void 0
            ? void 0
            : _a.id) || "123";
        const xata_class = XataRecords.classes.find(
          (clase) => clase.id === xata_class_id
        ...
        const xata_period_id =
          ((_c =
            xata_class === null || xata_class === void 0
              ? void 0
              : xata_class.period) === null || _c === void 0
            ? void 0
            : _c.id) || "123";
        const xata_period = XataRecords.periods.find(
          (period) => period.id === xata_period_id
